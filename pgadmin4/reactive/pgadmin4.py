...
def install_pgadmin4():
    ...
    def download_image(relation):
        ...
        relation.send_configuration(image, 'dpage/pgadmin4')
    ...
    @when('layer.docker-resource.dpage/pgadmin4.available')
    ...
    def restart_service():
        hookenv.service_restart('pgadmin4')
