...
schemata_names = ['public', 'a_horse', 'australian_addresses', 'cheirrs', 'cheirrs_oseer', 'chubba_morris', 'chubba_morris_oseer', 'convey_it', 'convey_it_oseer', 'iot', 'the_general',  'the_general_oseer', 'tiger', 'tiger_data', 'topology']
